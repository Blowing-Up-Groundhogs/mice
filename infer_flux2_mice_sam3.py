"""
Script for running MICE inference on the SAM3-masked MICE-Bench dataset.
"""
import sys
import argparse
import torch
...
import random
from mice_dataset_mobius import get_mice_mobius_dataloader
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run MICE inference on the SAM3-masked MICE-Bench dataset.")

    parser.add_argument("--pretrained_model_name_or_path", type=str, default="black-forest-labs/FLUX.2-klein-4B")
    parser.add_argument("--dataset_root", type=str, default="/mnt/ssd1/mice_bench_sam3",
                        help="Root directory of the SAM3-masked MICE-Bench dataset")
    parser.add_argument("--output_dir", type=str, default="results_micebench_sam3")
...
def main():
    ...
    save_dir = Path(args.output_dir) / f"mice_flux2_sam3_{args.exp_name}"
    ...
    dataloader = get_mice_mobius_dataloader(
